...
//hih
export default function ElementPopUp(props) {
  ...
  const getOptions = () => [
    { id: "active", title: "Sinh viên" },
    { id: "inActive", title: "Đang đi học" },
    { id: "All", title: "Đã đi làm" },
  ];
  ...
  return (
    <Paper>
      <Dialog maxWidth="md" open={OpenPopUp} onClose={handleClose}>
        <DialogTitle>
          <PageHeader title="Tạo thông tin" subTitle="Thông cái nhân" icon={getIcon("gala:add")} />
        </DialogTitle>
        <DialogContent>
